...
`;function CT({blogTitle:n=""}){return ee.jsx(R5,{children:ee.jsx(C5,{to:"/",children:n})})}const D5=ge.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`;function O5({currentTitle:n,onClose:e,onApply:t}){const[r,a]=W.useState(n);return ee.jsx(D5,{children:ee.jsxs(P5,{children:[ee.jsx("h3",{children:"블로그 이름 설정"}),ee.jsx(x5,{type:"text",value:r,onChange:o=>a(o.target.value)}),ee.jsxs(N5,{children:[ee.jsx(dS,{color:"gray",onClick:e,children:"Cancel"}),ee.jsx(dS,{color:"blue",onClick:()=>t(r),children:"Apply"})]})]})})}const k5=ge.aside`
  width: 280px;
  padding: 1rem;
...
`;function lP({explorePosts:n=[],blogTitle:e,setBlogTitle:t}){const r=id(),[a,o]=W.useState(!1),h=((f,p=3)=>Array.isArray(f)?[...f].sort(()=>.5-Math.random()).slice(0,p):[])(n);return ee.jsxs(k5,{children:[ee.jsx(V5,{children:"Explore Postings"}),h.map((f,p)=>{var y;return ee.jsxs(M5,{onClick:()=>r(`/post/${f.id}`),children:[ee.jsxs(L5,{children:[ee.jsx(U5,{})," ",f.writer," / ",f.title]}),ee.jsxs(B5,{children:[(y=f.content)==null?void 0:y.slice(0,40),"..."]})]},p)}),ee.jsxs("div",{style:{display:"flex",gap:"10px",marginTop:"2rem"},children:[ee.jsx(fS,{color:"blue",onClick:()=>r("/write"),children:"Write"}),ee.jsx(fS,{color:"gray",onClick:()=>o(!0),children:"Settings"})]}),a&&ee.jsx(O5,{currentTitle:e,onClose:()=>o(!1),onApply:f=>{t(f),o(!1)}})]})}const z5=ge.div`
  margin: 1.5rem 0;
  position: relative;
`,F5=ge.input`
  width: 100%;
...
`,j5=ge(uP)`
  right: 8px;
`;function H5({placeholder:n="Title, Contents...",onSearch:e}){const[t,r]=W.useState(""),a=()=>{e(t)},o=()=>{r(""),e("")},u=h=>{h.key==="Enter"&&a()};return ee.jsxs(z5,{children:[ee.jsx(F5,{placeholder:n,value:t,onChange:h=>r(h.target.value),onKeyDown:u}),t&&ee.jsx(j5,{src:"chamkkae-miniblog/src/assets/clear.svg",alt:"Clear",onClick:o}),ee.jsx(q5,{src:"chamkkae-miniblog/src/assets/search.svg",alt:"Search",onClick:a})]})}const G5=ge.div`
  display: flex;
...
`,Z5=ge.div`
  ...
  border-radius: 50%;
  margin-right: 5px;
`;function J5({post:n}){const{id:e,title:t,date:r,content:a,writer:o,image:u,dataPostTitle:h,dataPostedDate:f,dataPostContent:p,dataWriterName:y,dataImage:v}=n,w=id(),S=()=>{w(`/post/${e}`)},P=u||v||"https://i.ibb.co/sp7Q84Pg/idleimage.webp";return ee.jsxs(G5,{onClick:S,style:{cursor:"pointer"},children:[ee.jsx($5,{src:P,alt:"thumbnail"}),ee.jsxs(K5,{children:[ee.jsx(Q5,{children:t||h}),ee.jsx(W5,{children:r||f}),ee.jsx(Y5,{children:(a==null?void 0:a.slice(0,60))||(p==null?void 0:p.slice(0,60))}),ee.jsxs(X5,{children:[ee.jsx(Z5,{})," by ",o||y]})]})]})}const e9=ge.div`
  display: flex;
`,t9=ge.div`
  flex: 1;
  padding: 32px;
`;function n9(){const{posts:n}=Rd(),[e,t]=W.useState([]),[r,a]=W.useState(""),[o,u]=W.useState("Blog.MyBlog");W.useEffect(()=>{if(!r.trim())t(n);else{const p=r.toLowerCase(),y=n.filter(v=>{var w;return(w=v.title)==null?void 0:w.toLowerCase().includes(p)});t(y)}async function f(){const p=await MD();u(p)}f()},[n,r]);const h=f=>{a(f)};return ee.jsxs(ee.Fragment,{children:[ee.jsx(CT,{blogTitle:o}),ee.jsxs(e9,{children:[ee.jsxs(t9,{children:[ee.jsx(H5,{onSearch:h}),e.slice().reverse().map(f=>ee.jsx(J5,{post:f},f.id))]}),ee.jsx(lP,{explorePosts:n,blogTitle:o,setBlogTitle:async f=>{await b6(f),u(f)}})]})]})}const r9=ge.div`
  padding: 32px;
...
`;function l9({image:n}){const{addPost:e}=Rd(),[t,r]=W.useState({title:"",writer:"",password:"",content:"",image:"https://i.ibb.co/sp7Q84Pg/idleimage.webp"}),a=u=>{const{name:h,value:f}=u.target;r({...t,[h]:f})},o=u=>{u.preventDefault();const h={...t,image:n||t.image};e(h)};return ee.jsxs(r9,{children:[ee.jsx(i9,{children:"New Post"}),ee.jsxs(s9,{children:[ee.jsx(Py,{name:"title",value:t.title,onChange:a,placeholder:"Title"}),ee.jsx(Py,{name:"writer",value:t.writer,onChange:a,placeholder:"Name"}),ee.jsx(Py,{name:"password",value:t.password,onChange:a,placeholder:"Password"})]}),ee.jsx(a9,{name:"content",value:t.content,onChange:a,placeholder:"Something Plz..."}),ee.jsx(o9,{onClick:o,children:"Upload"})]})}const u9=ge.div`
  border: 1px solid #ccc;
  border-radius: 6px;
  padding: 16px;
...
`,d9=ge.p`
  ...
  font-size: 13px;
  margin-top: 6px;
`;function f9({onImageEncoded:n}){const[e,t]=W.useState(null),[r,a]=W.useState(""),o=u=>{const h=u.target.files[0];if(!h)return;if(h.size>512*1024){a("이미지 용량은 512KB 이하만 가능합니다.");return}const f=new FileReader;f.onloadend=()=>{const p=f.result;t(p),a(""),n(p)},f.readAsDataURL(h)};return ee.jsxs(u9,{children:[ee.jsx(c9,{children:"Image Upload"}),ee.jsx("input",{type:"file",accept:"image/*",onChange:o}),r&&ee.jsx(d9,{children:r}),e&&ee.jsx(h9,{src:e,alt:"미리보기"})]})}const m9=ge.div`
  display: flex;
`,p9=ge.div`
  flex: 1;
  padding: 32px;
`,g9=ge.div`
  ...
  padding: 32px 16px;
  border-left: 1px solid #ddd;
`;function _9(){const[n,e]=W.useState(null),[t,r]=W.useState("Blog.MyBlog");return W.useEffect(()=>{MD().then(r)},[]),ee.jsxs(ee.Fragment,{children:[ee.jsx(CT,{blogTitle:t}),ee.jsxs(m9,{children:[ee.jsx(p9,{children:ee.jsx(l9,{image:n})}),ee.jsx(g9,{children:ee.jsx(f9,{onImageEncoded:e})})]})]})}const y9=ge.div`
  border: 1px solid #ddd;
  border-radius: 6px;
  padding: 1rem;
  margin-bottom: 1rem;
...
`,b9=ge.p`
  font-size: 0.9rem;
`;function I9(n){const r=(Date.now()-n)/1e3,a=r/60,o=a/60,u=o/24,h=u/7;return r<60?"just now":a<60?`${Math.floor(a)} minutes ago`:o<24?`${Math.floor(o)} hours ago`:u<7?`${Math.floor(u)} days ago`:`${Math.floor(h)} weeks ago`}function A9({comment:n={}}){const{writer:e="",content:t="",rating:r=3,date:a=Date.now()}=n,o=I9(a);return ee.jsxs(y9,{children:[ee.jsxs(v9,{children:[ee.jsx(T9,{}),e," · ",o]}),ee.jsx(w9,{children:[1,2,3,4,5].map(u=>ee.jsx(E9,{$active:u<=r,children:"★"},u))}),ee.jsx(b9,{children:t})]})}const S9=ge.div`
  border: 1px solid #ddd;
  border-radius: 6px;
  padding: 16px;
  margin-top: 16px;
...
`,x9=ge.button`
  ...
  border-radius: 6px;
  cursor: pointer;
`;function N9({postId:n}){const{addComment:e}=Rd(),[t,r]=W.useState(""),[a,o]=W.useState(3),[u,h]=W.useState(""),f=()=>{if(!t)return alert("내용을 입력해주세요.");const p={id:Date.now(),writer:u,content:t,rating:a,date:Date.now()};e(n,p),r(""),o(3)};return ee.jsx(S9,{children:ee.jsxs(R9,{children:[ee.jsx(C9,{placeholder:"닉네임",value:u,onChange:p=>h(p.target.value)}),ee.jsx(cP,{placeholder:"댓글을 남겨주세요.",value:t,onChange:p=>r(p.target.value)}),ee.jsx(D9,{children:[1,2,3,4,5].map(p=>ee.jsx(P9,{$active:p<=a,onClick:()=>o(p),children:"★"},p))}),ee.jsx(x9,{onClick:f,children:"Send"})]})})}const O9=ge.button`
...
`;function Cv({children:n,onClick:e,color:t="#2a4edc"}){return ee.jsx(O9,{color:t,onClick:e,children:n})}const k9=ge.div`
  position: fixed;
...
`,M9=ge.input`
  ...
  border: 1px solid #ccc;
  border-radius: 6px;
`;function L9({postId:n,onClose:e}){const[t,r]=W.useState(""),a=id(),{setPosts:o}=Rd(),u=async()=>{const h=Ji(eu,"post",n),f=await ZE(h);if(!f.exists()){alert("게시글을 찾을 수 없습니다.");return}const p=f.data().password;t===p?(await PC(h),o(y=>y.filter(v=>v.id!==n)),e(),a("/"),alert("게시글이 삭제되었습니다."),e(),a("/")):alert("비밀번호가 일치하지 않습니다.")};return ee.jsx(k9,{children:ee.jsxs(V9,{children:[ee.jsx("h3",{children:"비밀번호 확인"}),ee.jsx(M9,{type:"password",placeholder:"비밀번호 입력",value:t,onChange:h=>r(h.target.value)}),ee.jsxs("div",{style:{display:"flex",justifyContent:"space-between",gap:"10px"},children:[ee.jsx(Cv,{onClick:u,color:"red",children:"삭제"}),ee.jsx(Cv,{onClick:e,color:"gray",children:"취소"})]})]})})}const U9=ge.div`
  display: flex;
`,B9=ge.div`
  flex: 1;
  padding: 2rem;
...
`;const j9=ge.p`
  font-size: 0.9rem;
  color: #444;
`;function H9(){const{id:n}=TN(),{posts:e,setPosts:t}=Rd(),r=e.find(u=>String(u.id)===n),[a,o]=W.useState(!1);return r?ee.jsxs(ee.Fragment,{children:[ee.jsx(CT,{blogTitle:`${r.writer}의 글`}),ee.jsxs(U9,{children:[ee.jsxs(B9,{children:[ee.jsxs(z9,{children:[ee.jsx("h2",{children:r.title||r.dataPostTitle}),ee.jsxs(F9,{children:[ee.jsx(q9,{}),r.writer||r.dataWriterName," | ",r.date||r.dataPostedDate]}),ee.jsx(j9,{children:r.content||r.dataPostContent}),ee.jsx("img",{src:r.image,style:{maxHeight:"40%",margin:"16px 0",borderRadius:"8px"}})]}),ee.jsx("h4",{children:"Reply"}),r.comments.map(u=>ee.jsx(A9,{comment:u},u.id)),ee.jsx(N9,{postId:r.id}),ee.jsx("div",{style:{textAlign:"right",marginTop:"32px"},children:ee.jsx(Cv,{color:"red",onClick:()=>o(!0),children:"Delete"})}),a&&ee.jsx(L9,{postId:r.id,onClose:()=>o(!1)})]}),ee.jsx(lP,{explorePosts:e})]})]}):ee.jsx("div",{children:"Post not found"})}const G9=document.getElementById("root"),$9=Gx.createRoot(G9);$9.render(ee.jsx(tu.StrictMode,{children:ee.jsx(sO,{basename:"/chamkkae-miniblog",children:ee.jsx(I6,{children:ee.jsxs(MN,{children:[ee.jsx(lm,{path:"/",element:ee.jsx(n9,{})}),ee.jsx(lm,{path:"/write",element:ee.jsx(_9,{})}),ee.jsx(lm,{path:"/post/:id",element:ee.jsx(H9,{})})]})})})}));
